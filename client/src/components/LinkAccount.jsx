...
export default function LinkAccount({ onClose, username }) {
  ...
  return (
    <Modal onClose={onClose} overlayClick={false}>
      <ModalTitle icon={<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>}>
        Link Email
      </ModalTitle>

      <ModalBody>
        {sent ? (
          <div className="card-stack" style={{ textAlign: 'center', padding: '1rem 0', gap: '1rem' }}>
          ...
          <div className="card-stack">
            ...
            <form onSubmit={handleSubmit} className="card-stack" style={{ gap: '1rem' }}>
              ...
              <ModalActions className="modal-action-divider">
                <button type="button" className="btn-responsive" onClick={onClose} style={{ flex: 1 }}>Cancel</button>
                <button type="submit" className="primary btn-responsive" style={{ flex: 1 }} disabled={loading || !email}>
